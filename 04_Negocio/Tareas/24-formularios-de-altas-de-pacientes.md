...
- ✅ [24001] Crear las tablas en la base de datos para completar el flujo de Formularios de Altas de Pacientes
  ...
  Context: Diseñar y crear las tablas necesarias para soportar los templates de formularios, conceptos, formularios llenados y sus valores capturados.
...
- ✅ [24002] Crear la nueva API para completar el flujo de Formularios de Altas de Pacientes
  ...
  Context: crear la nueva API para soportar los templates de formularios, conceptos, formularios llenados y sus valores capturados.
...
- ✅ [24003] Crear endpoint para registro de templates de formulario por especialista
  ...
  Context: Agregar un endpoint que permita a un especialista crear un nuevo formulario tipo plantilla con una lista personalizada de conceptos y configuraciones.
...
- ✅ [24004] Crear endpoint para obtención de templates de formulario disponibles
  ...
  Context: Desarrollar el endpoint que retorne los formularios tipo plantilla disponibles para un especialista, incluyendo los generales del sistema y los propios.
...
- ✅ [24005] Crear formulario para registrar un nuevo template desde el panel del especialista
  ...
  Context: Diseñar una vista que permita a los especialistas crear un nuevo template de formulario y configurar sus conceptos, unidades, y si son graficables.
...
- ✅ [24006] Crear endpoint para guardar formulario clí­nico capturado durante una cita
  ...
  Context: Generar un endpoint para guardar un formulario lleno basado en un template y vinculado a una cita existente, incluyendo cada valor registrado.
...
- ✅ [24007] Implementar panel de atención de cita (consulta de paciente) para especialistas en nutrición
  ...
  Context: Agregar en la vista de consulta un formulario para que el especialista seleccione uno o más de los templates de formularios y capture los datos correspondientes del paciente. Esta vista debe ser accesible por el especialista desde el perfil del usuario o desde la cita asignada.
...
- ✅ [24008] Agregar validación de edición limitada por tiempo en formularios clí­nicos
  ...
  Context: Implementar lógica para permitir la edición directa de formularios clí­nicos solo dentro de los primeros 7 días desde su creación.
...
- ✅ [24009] Agregar opción en frontend para editar formularios clí­nicos
  ...
  Context: Permitir que el especialista edite los formularios clí­nicos llenados recientemente si están dentro del periodo permitido de edición (7 días).
...
- ✅ [24010] Crear lógica para duplicar formulario clí­nico vencido y crear uno nuevo editable
  ...
  Context: Agregar lógica backend para clonar formularios clí­nicos cuando han pasado más de 7 días y crear una nueva instancia editable.
...
- ✅ [24011] Diseñar y desarrollar vista para mostrar el histórico de formularios llenados en citas del paciente
  ...
  Context: Diseñar la vista que muestre el historial de formularios llenados en cada cita del paciente con la opción de ver detalles.
...
- ✅ [24014] Agregar una bandera a los templates para identificarlos como una "Valoración inicial"
  ...
  Context: Agregar una bandera a los formularios clí­nicos para indicar que el formulario es una "Valoración inicial" esto para complementar el registro o alta de un nuevo paciente. El especialista puede tener más de un template para "Valoraciones iniciales"
...
- ✅ [24015] Desarrollar el flujo para dar de Alta a un paciente
  ...
  Context: Este flujo de alta de paciente consiste en dos formularios uno para para llenar los datos de registro de un paciente (ENDPOINT: `POST {{userHost}}/specialists/patient`) y el otro para llenar el formulario de "Valoración inicial" esto para complementar el registro de un nuevo paciente.
...
- ✅ [24016] Agregar campo `is_mandatory` a los `form_template_concepts`
  ...
  Context: Agregar bandera `is_mandatory` a los `form_template_concepts` (antes `form_template_units`) para que se indique si el campo es obligatorio de llenar en el formulario; esto con el fin de forzar los campos necesarios para el llenado de las fórmulas de los dietocalculos
...
- ✅ [24017] Crear formularios de "Valoración inicial (Multinature)" y "Dietocalculos (Multinature)"
  ...
  Context: Crear los formularios con sus respectivos campos obligatorios
...
- ✅ [24018] Actualizar el funcionamiento de los `form_template_concepts` y los `concepts` para que sea afín al frontend
  ...
  Context: Realizar los ajustes acordados durante la videollamada del 15 de abril. La intención que desde el `POST {{formHost}}/forms/template` se creen también los `concepts`
...
- ✅ [24019] Al crear un paciente activar su usuario para permitir la actualización de su contraseña
  ...
  Context: Cuando un especialista crea un nuevo paciente (endpoint `POST /specialists/patient`) activar la cuenta de ese nuevo usuario (`isActive: true`) para permitir la actualización de su contraseña
...
- ✅ [24020] Desarrollar la posibilidad de agregar metas a los conceptos gráficables de los formularios
  ...
  Context: Desarrollar la opción de agregar metas a los conceptos gráficables de los formularios, por ejemplo en el concepto "Peso" un especialista debe poder agregar el peso actual de su paciente y la meta a la que debe llegar para el fin de esa dieta
...
- ✅ [24021] Agrupar los formularios que son de "Valoración inicial"
  ...
  Context: Yo como especialista quiero ver los formularios de "Valoración inicial" agrupados en el select de formularios al desarrollar una consulta y al dar de alta a un nuevo paciente
...
- ✅ [24023] Al crear un formulario siempre agregar los conceptos de la altura y peso
  ...
  Context: Al crear un template de formulario por default siempre agregar los conceptos de la altura y peso aunque el especialista no los agregue explicitamente a su petición de creación del formulario
...
- ✅ [24024] Categorizar las preguntas de los formularios
  ...
  Context: Agregar un campo de category que sea un enum de los diferentes tipos de preguntas que pueden existir, con el fin de agruparlas y hacer más sencilla su búsqueda/uso
...
- ✅ [24025] Agregar preguntas genericas para los formularios de rutinas y de dietas.
  ...
  Context: Considerar agregar las siguientes categorías de preguntas para casos de uso del módulo de rutinas:
