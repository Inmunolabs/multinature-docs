# 2.0 Operatividad del Especialista – Documento Completo

## 🎯 Objetivo

Garantizar que los especialistas puedan **crear, editar, visualizar y administrar menús**, formularios y datos clínicos sin fricción.
...
## 1.0. SMAE – Normalización y Cache
...
## 1.1. CRUD de Menús (Manual + IA)

### Problemas actuales

- Menús generados por IA no son editables desde la interfaz.
- Menús manuales e IA están en vistas separadas.
...
- [ ] Endpoint CREATE menú.
- [ ] Endpoint UPDATE menú.
- [ ] Endpoint DELETE menú.
...
## 1.3. Formularios Clínicos Mejorados
...
- [ ] Normalizar unidades.
- [ ] Revisar migraciones (015, 016, 020).
- [ ] UI mejorada (Diego + Antoine).
- [ ] Documentación: `/doc/forms-structure.md`.

---

## 1.4. Historial Clínico Estructurado
