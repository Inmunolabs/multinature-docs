...
## 9. Resumen rápido de cambios propuestos

Para tenerlo a mano como checklist de implementación:

1. `concepts`

   - `ADD field_type varchar(30) NOT NULL DEFAULT 'text'`

2. `filled_form_values`

   - `ADD value_type varchar(30) NOT NULL DEFAULT 'text'`
   - `ADD value_number decimal(12,4) DEFAULT NULL`
   - `ADD value_json json DEFAULT NULL`
   - `ADD group_description varchar(255) DEFAULT NULL`
   - `ADD question_index int DEFAULT NULL`
...
4. `filled_forms`
   - `ADD template_version int NOT NULL DEFAULT 1`
   - `ADD template_snapshot json DEFAULT NULL` (opcional pero recomendado)
   - `ADD filled_by enum('specialist','patient','mixed') NOT NULL DEFAULT 'specialist'`

Con estos ajustes, el sistema de formularios clínicos queda mucho más robusto para:

- Evolucionar plantillas sin perder contexto histórico.
- Alimentar correctamente al dietAgent con datos estructurados y tipados.
- Soportar flujos mixtos donde tanto especialista como paciente participan en la captura de información.
