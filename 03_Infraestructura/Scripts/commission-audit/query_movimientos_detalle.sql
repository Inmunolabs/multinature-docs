-- Detail movements for commission audit (consumptions + commission_transactions).
-- Parameters: start_ts, end_ts (same window as main audit query).
-- See commission-audit-spec.md
