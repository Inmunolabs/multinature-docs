...
```javascript
{
  ...
  justification: 'GET calculado mediante Mifflin-St Jeor y Harris Benedict para paciente de 35 anos, 75 kg, 175 cm (IMC 24.5), sexo M y factor de actividad 1.40; se aplica ajuste -15% para objetivo "Bajar de peso" segun protocolo SMAE, resultando en 1870 kcal/dia.',
  rationale: '...',               // Alias interno para compatibilidad; la respuesta publica usa justification
