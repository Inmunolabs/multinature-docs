...
Antes de calcular el GET, puedes usar el endpoint **[POST /diets/recommend-formulas](../Endpoints/recommend-formulas.md)** para obtener una lista de fórmulas recomendadas basadas en el contexto clínico del paciente. Este endpoint recibe las respuestas del formulario y recomienda qué fórmulas son más apropiadas para el cálculo.
