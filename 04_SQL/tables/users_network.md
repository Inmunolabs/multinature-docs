...
- Usada para resolver la cadena de comisiones al comprar (uplines del comprador): [orders_commissions_and_consumption.md](../flows/orders_commissions_and_consumption.md).
